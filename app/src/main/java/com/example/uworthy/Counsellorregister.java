...
//                                                                  Firebase reference = new Firebase("https://uworthy-6fd8e.firebaseio.com/Counsellor");
//                                                                  savedata data = new savedata(id, name, emailid, mobileno, clnicaddress, gender, dob, useername, password, usertype, TempImageName, taskSnapshot.getStorage().getDownloadUrl().toString());
//
//                                                                  if (s.equals("null")) {
//                                                                      reference.child(useername).setValue(data);
//                                                                      Toast.makeText(Counsellorregister.this, "registration successful", Toast.LENGTH_LONG).show();
//                                                                  } else {
//                                                                      try {
...
//                                                                              reference.child(useername).setValue(data);
//                                                                              Toast.makeText(Counsellorregister.this, "registration successful", Toast.LENGTH_LONG).show();
//                                                                              Intent i = new Intent(Counsellorregister.this, Loginactivity.class);
//                                                                              startActivity(i);
//                                                                          } else {
//                                                                              Toast.makeText(Counsellorregister.this, "username already exists", Toast.LENGTH_LONG).show();
//                                                                          }
...
//                                                              }
//                                                          });
//                                                          RequestQueue rQueue = Volley.newRequestQueue(Counsellorregister.this);
//                                                          rQueue.add(request);
//                                                      }
