...
//
    ...
    public List<String> getAll_Simple() {
        ...
        String query= "SELECT * FROM"+myhelper. TABLE_NAME+"WHERE";
...
//                " FROM " + myhelper.TABLE_NAME;
        ...
        if (cursor.moveToFirst()) {
            do {
                studentList.add(i,cursor.getString(cursor.getColumnIndex(myhelper.NAME)));
                studentList.add(i,cursor.getString(cursor.getColumnIndex(myhelper.Body)));
                i+=1;
    ...
    public ArrayList<HashMap<String, String>> getStudentList(String no) {
            ...
            String[] columns = {
                    myhelper.NAME,myhelper.Title,myhelper.Body
            };
            SQLiteDatabase db = myhelper.getReadableDatabase();

            // selection criteria
            String selection = myhelper.NAME + " = ?";
            ...
            Cursor cursor = db.query(myhelper.TABLE_NAME, //Table to query
